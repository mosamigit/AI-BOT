...
# lemmatizer
stop_words_remove=[word for word in words if not word.lower() in stop_words]
words = [lemmatizer.lemmatize(w.lower()) for w in stop_words_remove if w not in ignore_words]
